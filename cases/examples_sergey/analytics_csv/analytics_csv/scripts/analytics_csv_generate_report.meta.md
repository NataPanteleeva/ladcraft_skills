    ...
    properties:
      directory_id:
        oneOf:
          - type: integer
          - type: string
        description: ID папки Р7 Диск с CSV и для сохранения отчёта. По умолчанию 109.
      csv_name:
        type: string
      ...
      conflict_policy:
        type: string
        description: overwrite | suffix | error. По умолчанию overwrite — перезаписать существующий отчёт.
      auth_token:
        type: string
      base_url:
        type: string
