...
async function handler(state, params) {
	...
	return {
		...
		agent_message: `DOCX собран: ${fileName} (${sectionCount} раздел(ов), ${tableCount} таблиц). Вызови r7_save_compare_report_to_disk с content_base64, fileName и markdown отчёта.`
	};
}
