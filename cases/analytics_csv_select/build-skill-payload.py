...
def build_function_source(tool_name: str, script_file: str, runtime: str, env_schema: dict) -> str:
        ...
        tools.append(
            {
                ...
                "runtime": runtime,
                "function": build_function_source(name, script_file, runtime, env_schema),
