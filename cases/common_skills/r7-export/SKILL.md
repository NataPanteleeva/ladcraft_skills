...
3. Для ladcraft-r7 action-блоков добавь явную подсказку:
...
В display-части не показывай служебные JSON/tool traces (кроме `r7.task` блока, который нужен плагину).
