...
| Пользователь написал **«скачать»** (или `download`, `.md`, `.docx`) после отчёта | блок **download** |
| Оба слова в одном или разных сообщениях после отчёта | оба блока |
| Только cell-редактор | download (без insert) |

Навык/агент должен **предложить** пользователю написать в чате «вставить» или «скачать» — кнопки появятся под соответствующим отчётом автоматически.
...
**Скачать**: `.md` · `.html` (открывается в Word → «Сохранить как DOCX»)
